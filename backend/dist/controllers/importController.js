...
exports.deleteMurosBatch = deleteMurosBatch;
...
async function getMuros(req, res) {
    ...
    try {
        const pk_proyecto = parseInt(req.query.pk_proyecto);
...
async function deleteMurosBatch(req, res) {
    ...
    try {
        ...
        const result = await pool.query('DELETE FROM muro WHERE pk_proyecto = $1 AND pid = ANY($2::int[])', [pk_proyecto, pids]);
